...
function(_add_swift_executable_single name)
  ...
  cmake_parse_arguments(SWIFTEXE_SINGLE
    ...
    "SDK;ARCHITECTURE"
    "DEPENDS;LLVM_COMPONENT_DEPENDS;LINK_LIBRARIES;LINK_FAT_LIBRARIES;COMPILE_FLAGS;LINK_FLAGS"
    ${ARGN})
  ...
  handle_swift_sources(
      ...
      LINK_FLAGS ${SWIFTEXE_SINGLE_LINK_FLAGS}
      IS_MAIN)
...
function(add_swift_executable name)
  ...
  cmake_parse_arguments(SWIFTEXE
    "EXCLUDE_FROM_ALL;DONT_STRIP_NON_MAIN_SYMBOLS;DISABLE_ASLR"
    ""
    "DEPENDS;LLVM_COMPONENT_DEPENDS;LINK_LIBRARIES;COMPILE_FLAGS;LINK_FLAGS"
    ${ARGN})
  ...
  _add_swift_executable_single(
      ...
      LINK_FLAGS ${SWIFTEXE_LINK_FLAGS}
      ${SWIFTEXE_EXCLUDE_FROM_ALL_FLAG}
      ${SWIFTEXE_DONT_STRIP_NON_MAIN_SYMBOLS_FLAG}
      ${SWIFTEXE_DISABLE_ASLR_FLAG})
endfunction()
...
function(add_swift_host_tool executable)
  cmake_parse_arguments(
      ...
      "" # options
      "" # single-value args
      "SWIFT_COMPONENT;COMPILE_FLAGS;LINK_FLAGS;DEPENDS" # multi-value args
      ${ARGN})
  ...
  add_swift_executable(
    ...
    LINK_FLAGS ${ADDSWIFTHOSTTOOL_LINK_FLAGS}
  )

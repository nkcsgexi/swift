...
/// layout via that module. FoldingSet uniquing keys on (mangledName,
/// definingModule) so that "Library's Wrapper" and "OtherLib's Wrapper" remain
/// distinct even when their mangled names coincide.
